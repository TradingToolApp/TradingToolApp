...
import authorAPI from "@/libs/api-client/restful/author-api";
import {formatAuthors} from "@/utils/formatData";
...
export function useAddAuthor() {
    ...
    return useMutation({
        mutationFn: (data) => {
            return authorAPI.createAuthor(data)
        },
...
export function useUpdateAuthor() {
    ...
    return useMutation({
        mutationFn: (data) => {
            return authorAPI.updateAuthor(data)
        },
        onSuccess: (result: any) => {
            if (!result.success) {
                return toast.error(result.message, toastConfig.error as any);
...
export function useDeleteAuthor() {
    ...
    return useMutation({
        mutationFn: (data) => {
            return authorAPI.deleteAuthor(data)
        },
        onSuccess: (result: any) => {
            if (!result.success) {
                return toast.error(result.message, toastConfig.error as any);
