...
import youtubeAPI from "@/services/restful/widgets/youtube-api";
...
export function useGetYoutubeVideos(initialData = []) {
    const queryInfo  = useQuery({ queryKey: [ 'youtubeVideos' ], queryFn: youtubeAPI.getYoutubeVideos, placeholderData: {data: initialData} })
    return {
        ...queryInfo,
...
export function useAddYoutubeVideo() {
    ...
    return useMutation({
        ...
        mutationFn: (data) => {return youtubeAPI.createYoutubeVideo(data)},
...
export function useUpdateYoutubeVideo() {
    ...
    return useMutation({
        ...
        mutationFn: (data) => {return youtubeAPI.updateYoutubeVideo(data)},
        onSuccess: (result: any) => {
            if (!result.success) {
                return toast.error(result.message, toastConfig.error as any);
            }
...
export function useDeleteYoutubeVideo() {
    ...
    return useMutation({
        ...
        mutationFn: (data) => {return youtubeAPI.deleteYoutubeVideo(data)},
        onSuccess: (result: any) => {
            if (!result.success) {
                return toast.error(result.message, toastConfig.error as any);
            }
