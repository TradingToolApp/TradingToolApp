    ...
    <div className="sidebar-social-share-widget m-b-xs-40">
      <ul className="social-share-list-wrapper">
        <li className="social-share-list text-center perfect-square">
          <span href={SocialLink.fb.url} className="list-inner bg-color-facebook">
        ...
        <li className="social-share-list text-center perfect-square">
          <span href={SocialLink.twitter.url} className="list-inner bg-color-twitter">
        ...
        {/* End of .social-share-list */}
        <li className="social-share-list text-center perfect-square">
          <span href={SocialLink.yt.url} className="list-inner bg-color-youtube">
        ...
        {/* End of .social-share-list */}
        <li className="social-share-list text-center perfect-square">
          <span href={SocialLink.linked.url} className="list-inner bg-color-linkedin">
        ...
        {/* End of .social-share-list */}
        <li className="social-share-list text-center perfect-square">
          <span href={SocialLink.discord.url} className="list-inner bg-color-vimeo">
        ...
        {/* End of .social-share-list */}
        <li className="social-share-list text-center perfect-square">
          <span href={SocialLink.pinterest.url} className="list-inner bg-color-pinterest">
        ...
        {/* End of .social-share-list */}
        <li className="social-share-list text-center perfect-square">
          <span href={SocialLink.slack.url} className="list-inner bg-color-twitch">
        ...
        {/* End of .social-share-list */}
        <li className="social-share-list text-center perfect-square">
          <span href={SocialLink.instagram.icon} className="list-inner bg-color-instagram">
