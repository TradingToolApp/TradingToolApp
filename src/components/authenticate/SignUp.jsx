        ...
        <div className="axil-contact-form-block m-b-xs-30">
            ...
            <div className="axil-contact-form-wrapper p-t-xs-10">
                <form className="axil-contact-form row no-gutters" ref={form} onSubmit={sendEmail}>
                    <FormGroup pClass="col-12" type="text" label="Name" name="register-name" />
                    <FormGroup pClass="col-12" type="text" label="Phone" name="register-phone" />
                    <FormGroup pClass="col-12" type="email" label="Email" name="register-email" />
                    <FormGroup pClass="col-12" type="password" label="Password" name="register-password" />
