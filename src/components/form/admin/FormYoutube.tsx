...
import {useAddYoutubeVideo, useUpdateYoutubeVideo} from "@/hooks/data/admin/useYoutubeVideos";

const SelectPickerCustom = React.forwardRef<HTMLInputElement, any>((props: any, ref: any) => <SelectPicker
    searchable={false} menuMaxHeight={200}
    style={{width: "100px"}}
